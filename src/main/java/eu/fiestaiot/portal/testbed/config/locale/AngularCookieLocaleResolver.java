package eu.fiestaiot.portal.testbed.config.locale;
...
public class AngularCookieLocaleResolver extends CookieLocaleResolver {
    ...
    private void parseLocaleCookieIfNecessary(HttpServletRequest request) {
       ...
       /*Cookie jsesionCookie = WebUtils.getCookie(request, "JSESSIONID");
        if (jsesionCookie != null) {
             jsesionCookie.setValue(null);
                jsesionCookie.setMaxAge(0);
                //jsesionCookie.setPath(theSamePathAsYouUsedBeforeIfAny);
                request.addCookie(jsesionCookie);
        }*/
