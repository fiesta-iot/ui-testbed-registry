...
public class FiestaTestbedRegistryProperties {
    ...
    public static class Mail {
        ...
        private String from = "TestbedRegistry@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "TestbedRegistry API";

        private String description = "TestbedRegistry API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "TestbedRegistry";
