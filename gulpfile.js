// Generated on 2017-05-02 using generator-jbooter 1.12.1
'use strict';
...
gulp.task('assets:test', ['images', 'styles', 'html', 'copy:swagger', 'copy:images'], build);
...
gulp.task('build', ['clean'], function (cb) {
    runSequence(['copy', 'inject:vendor', 'ngconstant:test'], 'inject:app', 'inject:troubleshoot', 'assets:test', cb);
});
